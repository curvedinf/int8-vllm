...
| G128 target decode core | Gluon grouped-int8 3D attention (`VLLM_G128_GLUON=1`) | The AITER backend routes grouped target KV to the gfx908 vector-load/MFMA specialization. At TP4/C6 with six concurrent 32k API streams, two 800-output runs measured 232.98 and 252.59 aggregate decode-overlap tok/s versus 147.62 and 179.06 for the matched original-core control. A mixed 3-decode/3-prefill gate scored 0/6144 exact output tokens outside target top 20. The >300 tok/s goal remains open. |
