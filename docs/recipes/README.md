...
| Attention backend | **AITER unified attention** | target and draft both use the recipe KV dtype (int8_block_g16 since 2026-09-04) |
...
5. `.venv/bin/python scripts/ua_live_soak.py -n 500` — verify the exact
   ...
   the recipe dtype (int8_block_g16 since 2026-09-04), float32 Mamba state,
