...
start_server() {
  ...
  VLLM_OFFLOAD_LOADLOG="${VLLM_OFFLOAD_LOADLOG:-}" \
  VLLM_OFFLOAD_NOSTORE_DECODE="${VLLM_OFFLOAD_NOSTORE_DECODE:-}" \
  VLLM_KV_OFFLOAD_MAX_BATCH_DESCRIPTORS="${VLLM_KV_OFFLOAD_MAX_BATCH_DESCRIPTORS:-}" \
