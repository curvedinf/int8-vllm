...
def is_aiter_found_and_supported() -> bool:
    ...
    if current_platform.is_rocm() and IS_AITER_FOUND:
        ...
        # gfx908 (MI100, CDNA1) reports cdna_version 0, but the gfx908 fork
        # runs aiter's Triton/asm kernel subset (W8A16, RMSNorm) on it.
        return get_cdna_version() > 2 or on_gfx908()
    return False
