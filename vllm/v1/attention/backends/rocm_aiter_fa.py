    ...
    def forward(
        ...
        if not attn_metadata.use_cascade:
            ...
            if num_decodes > 0:
                ...
                # sliding window, sinks, or gfx908. The pa_fwd_asm and
                # paged_attention_v1 paths don't support sinks, and Triton PA
                # decode exceeds MI100 64KB LDS with large block sizes.
                ...
                if (
                    ...
                    assert not rocm_aiter_ops.is_shuffle_kv_cache_enabled(), (
                        ...
                        "window, sinks, speculative decoding (multi-token decode), "
                        "or gfx908."
                    )
